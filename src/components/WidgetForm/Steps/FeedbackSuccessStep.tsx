    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <button 
                    type="button"
                    className="py-2 px-6 mt-6 bg-brand-500 rounded-md border-transparent text-sm leading-6 hover:bg-brand-300 transition-colors focus:outline-none hover:ring-2 hover:ring-offset-2 hover:ring-offset-zinc-900 hover:ring-brand-500 focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:hover:bg-brand-500"
